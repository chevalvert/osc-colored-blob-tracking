...
public boolean is_picking_red, is_picking_green, is_picking_blue;
...
void initControls(int x, int y) {
  ...
  btn_picker_red = cp5.addToggle("is_picking_red")
    .setLabel("R")
    .setColorLabel(WHITE)
    .setColorBackground(BLUE)
    .setColorForeground(RED)
  ...
  btn_picker_green = cp5.addToggle("is_picking_green")
    .setLabel("G")
    .setColorLabel(WHITE)
    .setColorBackground(BLUE)
    .setColorForeground(RED)
  ...
  cp5.addButton("reset_pick_green")
    .setLabel("x")
    .setColorLabel(WHITE)
    .setColorBackground(BLUE)
    .setColorForeground(RED)
  ...
  btn_picker_blue = cp5.addToggle("is_picking_blue")
    .setLabel("B")
    .setColorLabel(WHITE)
    .setColorBackground(BLUE)
    .setColorForeground(RED)
